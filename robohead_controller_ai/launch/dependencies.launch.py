            ...
            actions=[
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        pkg_robohead_controller, 'config', 'neck_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[ PathJoinSubstitution([ pkg_robohead_controller, 'config', 'sensor_driver.yaml' ]) ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        pkg_robohead_controller, 'config', 'ears_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        pkg_robohead_controller, 'config', 'respeaker_driver.yaml'])
                    ]
                ),
