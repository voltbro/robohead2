...
def run(
    controller: TurtlebroController, action_name: str, cancel_event: threading.Event
):
    """
    Args:
    ...
    for k in range(6):
        # Трясём головой
        controller.turtlebro_driver.velocity_publish(linear_x=0.0, angular_z=2.0* (-1)**k)
