...
def generate_launch_description():
    # Найдём путь к пакету brover_controller (для config-файлов)
    pkg_brover_controller = FindPackageShare('brover_controller')

    return LaunchDescription([
        # Группа с пространством имён "brover_controller"
        GroupAction(
            actions=[
                ...
                Node(
                    ...
                    parameters=[
                        PathJoinSubstitution([pkg_brover_controller, 'config','silero_tts.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[
                        PathJoinSubstitution([pkg_brover_controller, 'config','media_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('brover_controller'), 'config', 'neck_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[ PathJoinSubstitution([ FindPackageShare('brover_controller'), 'config', 'sensor_driver.yaml' ]) ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('brover_controller'), 'config', 'ears_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('brover_controller'), 'config', 'respeaker_driver.yaml'])
                    ]
                ),
                ...
                GroupAction(
                    actions=[
                        ...
                        Node(
                            ...
                            namespace='kws',
                            parameters=[PathJoinSubstitution([
                                FindPackageShare('brover_controller'),
