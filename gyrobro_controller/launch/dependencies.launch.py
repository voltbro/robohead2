...
def generate_launch_description():
    ...
    pkg_robohead_controller = FindPackageShare('gyrobro_controller')
            ...
            actions=[
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('gyrobro_controller'), 'config', 'neck_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[ PathJoinSubstitution([ FindPackageShare('gyrobro_controller'), 'config', 'sensor_driver.yaml' ]) ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('gyrobro_controller'), 'config', 'ears_driver.yaml'])
                    ]
                ),
                ...
                Node(
                    ...
                    parameters=[PathJoinSubstitution([
                        FindPackageShare('gyrobro_controller'), 'config', 'respeaker_driver.yaml'])
                    ]
                ),
                ...
                GroupAction(
                    actions=[
                        ...
                        Node(
                            ...
                            namespace='kws',
                            parameters=[PathJoinSubstitution([
                                FindPackageShare('gyrobro_controller'),
