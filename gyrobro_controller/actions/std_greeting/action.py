...
# def run(robohead:RoboheadController, cmd: str, cancel_event,on_complete=None):
#     """
...
#     req1.is_block = False
#     req1.is_cycle = False
#     future1 = robohead.media_driver_srv_play_media.call(req1)
...
#     req2.duration = 0.5
#     req2.is_block = False
#     future2 = robohead.ears_driver_srv_ears_set_angle.call(req2)
